...
\newcommand{\vkrAssignmentGoal}{Разработать интеллектуальную систему,
    предназначенную для автоматической категоризации текстов на основе конкретного набора данных.}
\newcommand{\vkrAssignmentTasks}{%
    \item Провести обзор существующих подходов к классификации
    текстовых документов, включая как традиционные подходы,
    так и современные методы машинного обучения для обработки текстовой информации.
    \item Изучить и обосновать выбор набора данных для обучения и
    тестирования алгоритма (например, файлы на диске или письма электронной почты).
    \item Изучить особенности представления текстов документов для алгоритмов
    машинного обучения. Разработать методику предобработки текстовых документов.
    \item Реализовать алгоритмы классификации с использованием методов ИИ, например,
    наивного байесовского классификатора, метода опорных векторов, алгоритмов на
    основе деревьев решений и др.
    \item Провести обучение и тестирование алгоритма на подготовленном наборе
    данных, варьируя параметры предобработки и модели. Оценить эффективность
    алгоритма по стандартным метрикам качества классификации.
}
\newcommand{\vkrAssignmentStages}{%
    \item Изучение существующих подходов к классификации текстовых
    документов, включая как традиционные методы категоризации, так
    и современные методы машинного обучения для обработки текстовой
    информации. Обзор российских и зарубежных публикаций. (19.09.2025 – 14.10.2025).
    \item Выбор и формирование набора данных для обучения и тестирования алгоритма. (30.10.2025 – 20.11.2025).
    \item Разработка методики предобработки текстовых документов (01.12.2025 – 31.01.2026).
    \item Разработка и реализация алгоритма классификации с использованием методов машинного обучения (01.02.2026 – 30.04.2026).
    \item Обучение и тестирование алгоритма на подготовленном наборе данных.
    Оценка эффективность алгоритма по стандартным метрикам качества классификации.
    Формулировка выводов. (01.05.2026 – 31.05.2026).
    \item Оформление окончательного текста бакалаврской работы (июнь 2026 год).
}
