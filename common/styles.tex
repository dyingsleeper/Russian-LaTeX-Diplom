...
\AtBeginDocument{%
    ...
    \setlength{\parskip}{0pt}                       % Отбивка между абзацами основного текста не допускается.
}
...
%    hidelinks,                  % Hide links (removing color and border)
    pdftitle={\documentPdfTitle},    % Заголовок
    pdfauthor={\documentPdfAuthor},  % Автор
    pdfsubject={\documentPdfSubject},      % Тема
