...
\section{Полные модули системы классификации электронной почты}\label{app:A/modules}
...
\captiondelim{ }
\lstinputlisting[language={Python},%
    caption={Нейросетевой классификатор (\texttt{text\_classifier.py})},%
    label={lst:app/text-classifier}]{listings/text_classifier.py}
\endgroup
